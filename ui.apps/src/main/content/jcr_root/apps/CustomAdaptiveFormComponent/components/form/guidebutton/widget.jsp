...
<ui:includeClientLib categories="anele"/>
...
<div id="democontainer">
        <img id="${guideField.resource.valueMap['css']}" src= "${guideField.resource.valueMap['fileReference']}" alt =  "${guideField.resource.valueMap['altText']}" width="200px" height="200px"/>
        <div id="demotext">
